...
![english-grammer](english/english-grammer.png)

### 九大词性

![](english/1658560054984.png)

### 八大句子成分

![](english/1658560090778.png)


### 方位介词

![](english/1658560012253.png)

### 不同看区别

![](english/1656564246128.jpg)
...
I crack open the soda.

Poke the straw through the cap.
...
> We had an issue with the invoice. Can you please resubmit the invoice with the correct tax type? Please confirm once the corrected invoice is submitted.  我们的发票出了点问题。能否重新提交税种正确的发票?提交正确的发票后，请立即确认。

> Kindly find the attached file of invoice and packing list for review, thanks. 附件是发票和装箱单，请查收，谢谢。

> I just sent 856 and 810 to you. Could you help check if you have received it successfully? 我刚把856和810发给你了。你能帮忙检查一下是否收到了吗?

> Could you please advise/confirm if you are the right person to work with? If not, could you please help forward this email to the right person?  
...
| Key   | English                                                      |
| ----- | ------------------------------------------------------------ |
| `~`   | tilde、tweedle、squiggly line                                |
| **`** | grave accent、stress mark                                    |
| `!`   | exclamation point/mark                                       |
| `@`   | (commercial) at sign，直接读 at                              |
| `#`   | number sign、pound sign、octothorpe (/ˈɑːktoʊθɔːrp/)、hash mark；手机、电脑键盘上就读 pound |
| `$`   | dollar sign                                                  |
| `%`   | percent sign                                                 |
| `^`   | caret、up-arrow head、circumflex accent                      |
| `&`   | and sign、ampersand，口语里一般就读作 and                    |
| `*`   | asterisk (/ 'æstərɪsk/)、star                                |
| `(`   | opening parenthesis；) 叫做 closing parenthesis              |
...
| `?`   | question mark                                                |
| `/`   | slash                                                        |
| `"`   | quotation marks、straight quotation marks                    |
| `“`   | opening quotation marks                                      |
| `”`   | closing quotation marks                                      |
| `ʺ`   | inches（长度，英寸）或 seconds（时间，秒                     |
| `'`   | apostrophe（省略符号）、single quotation mark（单引号）      |
| `′`   | feet（长度，英尺）、minutes（时间，分）                      |
| `:`   | colon                                                        |
| `;`   | semi-colon                                                   |

## Other

###  Father's Day - Ali Siddiq


> Father's Day is the worst holiday in the world. 
> I've done the research. I already know. 
...
> Do you realize Halloween is number 6? 
