...
**示例 2：** 计一个学生类，属性有姓名和学号，可以给姓名和学号赋值，可以显示学生的姓名和学号
...
**优点 1：** 所有成员属性设置为私有，可以自己控制读写权限

**优点 2：** 于写权限，我们可以检测数据的有效性
...
![](cpp-core/1545533548532.png)

**练习案例 2：点和圆的关系**

设计一个圆形类（Circle），和一个点类（Point），计算点和圆的关系。

![](cpp-core/1545533829184.png)
...
![IMG_256](cpp-core/clip_image002.jpg)
