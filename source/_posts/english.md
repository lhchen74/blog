...
| spine                         | n. 脊柱，脊椎；刺；书脊                                      |
| spill                         | v. （使）溢出，流出；（东西）倒出，洒落；迅速涌出；（使）摔下；掉球；（非正式）向（某人）说出秘密；减少受风压力 <br />n. 溢出液，溅出；溢出量；摔下；职位空缺；木片，碎纸；小塞子 |
| comet                         | n. [天] 彗星                                                 |
...
| rough                         | adj. 粗糙的；粗略的；粗野的；艰苦的；未经加工的 vt. 使粗糙；粗暴对待；草拟<br />n. 艰苦；高低不平的地面；未经加工的材料；粗糙的部分 vi. 举止粗野 adv. 粗糙地；粗略地；粗暴地 |
...
| draft                         | n. 汇票；草稿；选派；（尤指房间、烟囱、炉子等供暖系统中的）（小股）气流 <br />vt. 起草；制定；征募 vi. 拟稿；绘样；作草图 adj. 初步画出或（写出）的；（设计、草图、提纲或版本）正在起草中的，草拟的；以草稿形式的；草图的 |
...
| strew                         | vt. 散播；撒满                                               |
| stray                         | v. 迷路，走失，偏离；逃离，离题，走神；（眼睛或手悠闲地）移动；出轨，有外遇；游荡，徘徊<br />adj. 走失的，无主的；离群的，孤立的；偶现的，偶发的；（物理量）杂散的 n. 走失宠物，无主家畜；离群者，走散者； |
...
| offense                       | n. 犯罪，过错；进攻；触怒；引起反感的事物di                  |
...
| define                        | vt. 定义；使明确；规定                                       |
| defining                      | adj. 最典型的；起决定性作用的 v. 规定（define的ing形式）；给…下定义；表明特征 |
...
| Word                          | Meaning                                                      |
| ----------------------------- | ------------------------------------------------------------ |
| marvel                        | v. 感到惊奇（或好奇）；大为赞叹 n. 令人惊异的人（或事）；不平凡的成果，成就；奇迹；十分有用（灵巧）的物（人）；惊讶，惊奇 |
| marvelous                     | adj. 了不起的；非凡的；令人惊异的；不平常的                  |
| marvelously                   | adv. 奇迹般地；不可思议地；令人惊讶地                        |
| pot                           | n. 壶；盆；罐 vt. 把…装罐；射击；节略 vi. 随手射击           |
| chore                         | n. 家庭杂务；日常的零星事务；讨厌的或累人的工作              |
| disgrace                      | n. 耻辱；丢脸的人或事；失宠 vt. 使……失宠；给……丢脸；使……蒙受耻辱；贬黜 |
...
| kidnap                        | vt. 绑架；诱拐；拐骗                                         |
| veterinarian [ˌvetərɪˈneriən] | n. [兽医] 兽医                                               |
| overlook                      | vt. 忽略；俯瞰；远眺；不计较，宽恕；施魔法于；监督；检查 n. 忽视；眺望；从高处能看到的景色 |
| prominent                     | adj. 突出的，显著的；杰出的；卓越的                          |
| anticipate                    | v. 预料，预期；预见，预计（并做准备）； 期盼，期望； 先于……做，早于……行动；在期限内履行（义务），偿还（债务）；提前使用 |
| aptitude                      | n. 天资；自然倾向；适宜                                      |
| famine                        | n. 饥荒；饥饿，奇缺                                          |
| stick                         | vt. 刺，戳；伸出；粘贴 vi. 坚持；伸出；粘住 n. 棍；手杖；呆头呆脑的人 |
| ranch                         | n. 大农场；大牧场 vi. 经营牧场；在牧场工作 vt. 经营牧场；在牧场饲养… |
| commission                    | n. 委员会；佣金；服务费；犯；委任；委任状 vt. 委任；使服役；委托制作 |
| misery                        | n. 痛苦，悲惨；不幸；苦恼；穷困                              |
| miserable                     | adj. 悲惨的；痛苦的；卑鄙的                                  |
| chimney                       | n. 烟囱                                                      |
| wicked                        | adj. 邪恶的；恶劣的；不道德的；顽皮的 adv. <俚语>非常，很    |
| hood                          | n. 头巾；覆盖；兜帽 vt. 罩上；以头巾覆盖                     |
| hoop                          | n. 箍；铁环；呼呼声 vt. 加箍于；包围 vi. 发呼呼声            |
| tuxedo                        | n. 男士无尾半正式晚礼服；无尾礼服                            |
| cereal                        | n. 谷类，谷物；谷类食品；谷类植物 adj. 谷类的；谷类制成的    |
| beam                          | n. 横梁；光线；电波；船宽；[计量] 秤杆 vt. 发送；以梁支撑；用…照射；流露 vi. 照射；堆满笑容 |
| flank                         | n. 侧面；侧翼；侧腹 vt. 守侧面；位于…的侧面；攻击侧面 vi. 侧面与…相接 adv. 在左右两边 |
...
我们使用工业级和经过战斗测试的bcrypt算法来安全地散列和加密密码。